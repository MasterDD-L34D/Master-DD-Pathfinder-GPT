...
| `classes.json` | Generato da `tools/generate_classes_races_archetypes.py` come riassunti meccanici OGL + import AoN (`tools/import_reference.py`, lotti 2026-07-19 e 2026-07-25 C4) | OGL 1.0a | Paizo Inc. / d20PFSRD | 2026-07-25 | 35 | `source_id`, `name`, `source`, `tags`, `prerequisites`, `references`, `reference_urls`, `notes` | Nessun nome proprio di setting; descrizioni sono riassunti meccanici originali in italiano. | 35 classi: 11 core + Magus (UM) + 6 APG + 1 UC + 9 ACG + 6 OA + 1 UW (Shifter). |
...
- ~~Valutare l'espansione con altre classi base~~ **Fatto (2026-07-19 + 2026-07-25 C4)**: `classes.json` copre ora 35 classi (11 core + Magus (UM) + 6 APG + 1 UC + 9 ACG + 6 OA + 1 UW). Restano escluse: Slayer, Ninja, Samurai, Antipaladin, Vigilante (residuo aperto, nessun caster tra loro tranne Antipaladin).
