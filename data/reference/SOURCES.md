...
| `classes.json` | Generato da `tools/generate_classes_races_archetypes.py` come riassunti meccanici OGL + import AoN (`tools/import_reference.py`, lotti 2026-07-19, 2026-07-25 C4 e 2026-07-26 C4-bis) | OGL 1.0a | Paizo Inc. / d20PFSRD | 2026-07-26 | 40 | `source_id`, `name`, `source`, `tags`, `prerequisites`, `references`, `reference_urls`, `notes` | Nessun nome proprio di setting; descrizioni sono riassunti meccanici originali in italiano. | 40 classi: 11 core + Magus (UM) + 7 APG + 3 UC + 10 ACG + 6 OA + 1 UW (Shifter) + 1 UI (Vigilante). |
...
- ~~Valutare l'espansione con altre classi base~~ **Fatto (2026-07-19 + 2026-07-25 C4 + 2026-07-26 C4-bis)**: `classes.json` copre ora 40 classi (11 core + Magus (UM) + 7 APG + 3 UC + 10 ACG + 6 OA + 1 UW + 1 UI) — tutte le classi dell'indice AoN, residuo chiuso.
