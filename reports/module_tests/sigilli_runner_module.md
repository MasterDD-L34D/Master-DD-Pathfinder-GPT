...
- Copertura API completata per health/modules/meta/download con e senza API key, includendo 401/404 e il comportamento di troncamento previsto quando `ALLOW_MODULE_DUMP=false`.【fc8c1a†L3-L12】【5c31d3†L11-L18】
