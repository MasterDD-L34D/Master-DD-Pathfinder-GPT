...
- Controllo file binding: tutti i `file_binding` del router puntano a moduli core presenti su disco; nessun riferimento mancante rilevato.【b133c4†L14-L15】【F:src/modules/base_profile.txt†L114-L122】
